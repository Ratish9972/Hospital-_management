...
class staff
{
    ...
    void new_staff()
    {
        ...
        sid = input.nextLine();
        System.out.print("name:Ratish");
        sname = input.nextLine();
        System.out.print("desigination:-eye");
        desg = input.nextLine();
        System.out.print("sex:male");
        sex = input.nextLine();
        System.out.print("salary:100000");
...
}class doctor
{
    ...
    {
        Scanner input = new Scanner(System.in);
        System.out.print("id:11");
        did = input.nextLine();
        System.out.print("name:veeru");
        dname = input.nextLine();
        System.out.print("specilization:knee");
        specilist = input.nextLine();
        System.out.print("work time:8");
        appoint = input.nextLine();
        System.out.print("qualification:mbbs");
        doc_qual = input.nextLine();
        System.out.print("room no.:hf4");
        droom = input.nextInt();
    }
    void doctor_info()
    {
...
class patient
{
    ...
    {
        Scanner input = new Scanner(System.in);
        System.out.print("id:01");
        pid = input.nextLine();
        System.out.print("name:charan");
        pname = input.nextLine();
        System.out.print("disease:dengue");
        disease = input.nextLine();
        System.out.print("sex:male");
        sex = input.nextLine();
        System.out.print("admit_status:9");
        admit_status = input.nextLine();
        System.out.print("age:21");
        age = input.nextInt();
    }
    void patient_info()
    {
...
class medical
{
    ...
    void new_medi()
    {
        ...
        System.out.print("comp:5-5-2023");
        med_comp = input.nextLine();
        System.out.print("exp_date:6-6-23");
        exp_date = input.nextLine();
        System.out.print("cost:5000");
        med_cost = input.nextInt();
        System.out.print("no of unit:5");
        count = input.nextInt();
    }
    void find_medi()
    {
...
class lab
{
    ...
    {
        Scanner input = new Scanner(System.in);
        System.out.print("fecility:7");
        fecility = input.nextLine();
        System.out.print("cost:9000");
